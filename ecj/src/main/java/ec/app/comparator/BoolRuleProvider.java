...
public class BoolRuleProvider extends RuleProvider {
    ...
    public List<Transform> getRules() {
        return List.of(
            ...
            Transform.of("a nor b -> not (a or b)", 
                    c(Nor.class, Nodes.Any("a"), Nodes.Any("b")),
                    c(Not.class, c(Or.class, Nodes.Any("a"), Nodes.Any("b")))), 
            Transform.of("a nand b -> not (a and b)", 
                    c(Nor.class, Nodes.Any("a"), Nodes.Any("b")),
                    c(Not.class, c(Or.class, Nodes.Any("a"), Nodes.Any("b")))), 
            Transform.of("not (a or b) -> a nor b", 
                c(Not.class, c(Or.class, Nodes.Any("a"), Nodes.Any("b"))),
                c(Nor.class, Nodes.Any("a"), Nodes.Any("b"))), 
            Transform.of("not (a and b) -> a nand b", 
                c(Not.class, c(Or.class, Nodes.Any("a"), Nodes.Any("b"))),
                c(Nor.class, Nodes.Any("a"), Nodes.Any("b"))), 
            // Transform.of("a xor b -> ", 
            //     c(Xor.class, c(Or.class, Nodes.Any("a"), Nodes.Any("b"))),
            //     c(Nor.class, Nodes.Any("a"), Nodes.Any("b"))), 
